...
- ?? `kubeconfig.yaml` ???????????????????Git ? Docker ????????????????????????
- Dockerfile ??????????`.dockerignore` ????????????????????????? `.env`??????API ?????????????
- GitHub Actions ? `Verify deployment image` ??? Node 24 ????????????????????? 404?????????? API ???
- ????????????????? Node 24 ????? initContainer ??**?? Git ??**??????????? SHA-256 ??????????????????? `node server.mjs`?????????? Node ????????????????? Node ???????????? main ?????
- ??????????? Pod ?????????GitHub ??????????????????? Pod ???????????????????????????????? API?
- ????????????`API_LIVE_ENABLED=false`?`LLM_PROVIDER=none`?`ZHIHU_KNOWLEDGE_ENABLED=false`?`API_SECURE_COOKIE=true`????????????????????????? API ????
- ???? 8080??? Service ??????? 80??? targetPort ?????? 8080?Ingress ??? TLS ????????????? `/api/health`?
- ?? 200m CPU / 256Mi ???????????????????????????????????????????????????????????
